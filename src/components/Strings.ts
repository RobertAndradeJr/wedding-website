...
export const Hashtag = 'AndradeHallowedding';
...
export const HomeStrings = {
  title: 'Robert & Mandi are getting married!',
  detail: {
    WHEN: 'When:',
    WHERE: 'Where:',
    ADDRESS: 'Address:',
  ...
  buttonText: 'RSVP',
  heroImage:
    'https://instagram.ffcm1-2.fna.fbcdn.net/vp/16a383f1d9b3a06d6972085e6cf7ae1d/5DFDB388/t51.2885-15/e35/41203721_691517357888913_5430100155676178400_n.jpg?_nc_ht=instagram.ffcm1-2.fna.fbcdn.net'
};
...
export const registryStrings = {
  TITLE: 'Registry',
  URL:
    'https://www.myregistry.com/wedding-registry/mandi-holst-and-robert-andrade-minneapolis-mn/2531202'
};
